...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css/designer/style.css'); ?>">
    <link rel="stylesheet" href="<?= base_url('css/designer/sidebar.css'); ?>">
    <link rel="stylesheet" href="<?= base_url('css/designer/navbar.css'); ?>">
